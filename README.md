...
- Allowed consonant/vowel patterns
- Word formation guidelines
- Early grammar and syntax components

As the language develops, these documents will grow with examples, clarifications, and refinements.
...
- Propose changes or new rules
- Start discussions about grammar, vocabulary, or structure
- Suggest improvements to clarity or consistency
- Debate design decisions
- Submit tools, scripts, or resources that help the project

**Every idea matters.**  
Whether you are interested in linguistics, conlang design, phonology, or just want to help shape something new, this project is built for collaboration.
...
Bring your ideas. Challenge the rules. Help refine the system.
